...
public final class ParameterFormatterBenchmark_latency3Params {
    ...
    public Collection<? extends Result> latency3Params_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_parameterformatterbenchmark0_G.latency3Params(l_threadstate2_1));
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            latency3Params_thrpt_jmhStub(control, res, l_threadstate2_1, l_parameterformatterbenchmark0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "latency3Params", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void latency3Params_thrpt_jmhStub(InfraControl control, RawResults result, ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1, ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> latency3Params_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G = _jmh_tryInit_f_parameterformatterbenchmark0_G(control, threadParams);
            ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1 = _jmh_tryInit_f_threadstate2_1(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            latency3Params_avgt_jmhStub(control, res, l_threadstate2_1, l_parameterformatterbenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "latency3Params", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void latency3Params_avgt_jmhStub(InfraControl control, RawResults result, ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1, ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> latency3Params_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G = _jmh_tryInit_f_parameterformatterbenchmark0_G(control, threadParams);
            ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1 = _jmh_tryInit_f_threadstate2_1(control, threadParams);
            ...
            latency3Params_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_threadstate2_1, l_parameterformatterbenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_parameterformatterbenchmark0_G.latency3Params(l_threadstate2_1));
    ...
    public Collection<? extends Result> latency3Params_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G = _jmh_tryInit_f_parameterformatterbenchmark0_G(control, threadParams);
            ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1 = _jmh_tryInit_f_threadstate2_1(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            latency3Params_ss_jmhStub(control, batchSize, res, l_threadstate2_1, l_parameterformatterbenchmark0_G, l_blackhole1_0);
            control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "latency3Params", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void latency3Params_ss_jmhStub(InfraControl control, int batchSize, RawResults result, ParameterFormatterBenchmark_ThreadState_jmh l_threadstate2_1, ParameterFormatterBenchmark_jmh l_parameterformatterbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
