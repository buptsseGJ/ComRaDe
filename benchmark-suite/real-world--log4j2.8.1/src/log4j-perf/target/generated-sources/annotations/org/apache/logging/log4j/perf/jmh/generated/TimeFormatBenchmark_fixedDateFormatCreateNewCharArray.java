...
public final class TimeFormatBenchmark_fixedDateFormatCreateNewCharArray {
    ...
    public Collection<? extends Result> fixedDateFormatCreateNewCharArray_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_timeformatbenchmark0_G.fixedDateFormatCreateNewCharArray(l_bufferstate2_1));
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            fixedDateFormatCreateNewCharArray_thrpt_jmhStub(control, res, l_bufferstate2_1, l_timeformatbenchmark0_G, l_blackhole1_0);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "fixedDateFormatCreateNewCharArray", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fixedDateFormatCreateNewCharArray_thrpt_jmhStub(InfraControl control, RawResults result, TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1, TimeFormatBenchmark_jmh l_timeformatbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> fixedDateFormatCreateNewCharArray_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            TimeFormatBenchmark_jmh l_timeformatbenchmark0_G = _jmh_tryInit_f_timeformatbenchmark0_G(control, threadParams);
            TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1 = _jmh_tryInit_f_bufferstate2_1(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            fixedDateFormatCreateNewCharArray_avgt_jmhStub(control, res, l_bufferstate2_1, l_timeformatbenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "fixedDateFormatCreateNewCharArray", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fixedDateFormatCreateNewCharArray_avgt_jmhStub(InfraControl control, RawResults result, TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1, TimeFormatBenchmark_jmh l_timeformatbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> fixedDateFormatCreateNewCharArray_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            TimeFormatBenchmark_jmh l_timeformatbenchmark0_G = _jmh_tryInit_f_timeformatbenchmark0_G(control, threadParams);
            TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1 = _jmh_tryInit_f_bufferstate2_1(control, threadParams);
            ...
            fixedDateFormatCreateNewCharArray_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_bufferstate2_1, l_timeformatbenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_timeformatbenchmark0_G.fixedDateFormatCreateNewCharArray(l_bufferstate2_1));
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "fixedDateFormatCreateNewCharArray", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fixedDateFormatCreateNewCharArray_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1, TimeFormatBenchmark_jmh l_timeformatbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> fixedDateFormatCreateNewCharArray_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            TimeFormatBenchmark_jmh l_timeformatbenchmark0_G = _jmh_tryInit_f_timeformatbenchmark0_G(control, threadParams);
            TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1 = _jmh_tryInit_f_bufferstate2_1(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            fixedDateFormatCreateNewCharArray_ss_jmhStub(control, batchSize, res, l_bufferstate2_1, l_timeformatbenchmark0_G, l_blackhole1_0);
            control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "fixedDateFormatCreateNewCharArray", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void fixedDateFormatCreateNewCharArray_ss_jmhStub(InfraControl control, int batchSize, RawResults result, TimeFormatBenchmark_BufferState_jmh l_bufferstate2_1, TimeFormatBenchmark_jmh l_timeformatbenchmark0_G, Blackhole_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
